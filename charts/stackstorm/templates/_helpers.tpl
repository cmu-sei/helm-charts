...
{{/*
consolidate pack-configs-secrets projection definition
*/}}
{{- define "stackstorm-ha.pack-configs-from-helm-volume-projection" -}}
  {{- if or .Values.st2.packs.configs .Values.st2.existingPacksConfigSecret }}
  projected:
    sources:
    ...
    {{- end -}}
    {{- if .Values.st2.existingPacksConfigSecret }}
    - secret:
        name: {{ $.Values.st2.existingPacksConfigSecret }}
    {{- end -}}
  {{- end -}}
{{- end -}}
...
- name: st2-pack-configs-from-helm-vol
  {{- include "stackstorm-ha.pack-configs-from-helm-volume-projection" . }}
  {{- end }}
  {{- else }}
- name: st2-pack-configs-vol
  {{- include "stackstorm-ha.pack-configs-from-helm-volume-projection" . }}
