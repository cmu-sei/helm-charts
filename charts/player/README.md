...
| `player-api.env.Database__DevModeRecreate` | Recreate database on startup (dev only) | `false` |
| `player-api.env.Database__Provider` | Database provider | `PostgreSQL` |
...
| `player-api.env.Authorization__TokenUrl` | Token endpoint | `https://identity.example.com/connect/token` |
| `player-api.env.Authorization__AuthorizationScope` | OAuth scopes | `player-api` |
| `player-api.env.Authorization__ClientId` | OAuth client ID | `vm-api` |
| `player-api.env.Authorization__ClientSecret` | OAuth2 client secret | `""` |
| `player-api.env.Authorization__RequireHttpsMetaData` | Require HTTPS for metadata | `false` |
...
| `player-api.env.Logging__Debug__LogLevel__Microsoft` | Debug log level Microsoft | `Error` |
| `player-api.env.Logging__Debug__LogLevel__System` | Debug log level System | `Error` |
| `player-api.env.Logging__Console__LogLevel__Default` | Console log level default | `Information` |
| `player-api.env.Logging__Console__LogLevel__Microsoft` | Console log level Microsoft | `Error` |
| `player-api.env.Logging__Console__LogLevel__System` | Console log level System | `Error` |
...
| `player-api.env.CorsPolicy__Methods__0` | CORS allowed methods | `""` |
| `player-api.env.CorsPolicy__Headers__0` | CORS allowed headers | `""` |
| `player-api.env.CorsPolicy__AllowAnyOrigin` | Allow any CORS origin | `false` |
| `player-api.env.CorsPolicy__AllowAnyMethod` | Allow any CORS method | `true` |
| `player-api.env.CorsPolicy__AllowAnyHeader` | Allow any CORS header | `true` |
| `player-api.env.CorsPolicy__SupportsCredentials` | CORS supports credentials | `true` |
...
| `player-api.env.Notifications__HelpDeskApplicationName` | Help desk application name | `"Help Desk"` |
...
| `player-api.env.FileUpload__allowedExtensions__0` | Allowed file extension | `.pdf` |
| `player-api.env.FileUpload__allowedExtensions__1` | Allowed file extension | `.png` |
| `player-api.env.FileUpload__allowedExtensions__2` | Allowed file extension | `.jpg` |
| `player-api.env.FileUpload__allowedExtensions__3` | Allowed file extension | `.jpeg` |
| `player-api.env.FileUpload__allowedExtensions__4` | Allowed file extension | `.doc` |
| `player-api.env.FileUpload__allowedExtensions__5` | Allowed file extension | `.docx` |
| `player-api.env.FileUpload__allowedExtensions__6` | Allowed file extension | `.gif` |
| `player-api.env.FileUpload__allowedExtensions__7` | Allowed file extension | `.txt` |
...
| `vm-api.env.Database__DevModeRecreate` | Recreate database on startup (dev only) | `false` |
| `vm-api.env.Database__Provider` | Database provider | `PostgreSQL` |
...
| `vm-api.env.Authorization__TokenUrl` | Token endpoint | `https://identity.example.com/connect/token` |
| `vm-api.env.Authorization__AuthorizationScope` | OAuth scopes | `vm-api player-api` |
| `vm-api.env.Authorization__ClientId` | OAuth client ID | `vm-api` |
| `vm-api.env.Authorization__ClientSecret` | OAuth2 client secret | `""` |
| `vm-api.env.Authorization__RequireHttpsMetaData` | Require HTTPS for metadata | `false` |
...
| `vm-api.env.Logging__Debug__LogLevel__Microsoft` | Debug log level Microsoft | `Error` |
| `vm-api.env.Logging__Debug__LogLevel__System` | Debug log level System | `Error` |
| `vm-api.env.Logging__Console__LogLevel__Default` | Console log level default | `Information` |
| `vm-api.env.Logging__Console__LogLevel__Microsoft` | Console log level Microsoft | `Error` |
| `vm-api.env.Logging__Console__LogLevel__System` | Console log level System | `Error` |
...
| `vm-api.env.IdentityClient__ClientId` | Service account client ID | `vm-api` |
| `vm-api.env.IdentityClient__Username` | Service account username | `vm-service` |
| `vm-api.env.IdentityClient__Password` | Service account password | `password` |
| `vm-api.env.IdentityClient__Scope` | Service account scopes | `player-api` |
| `vm-api.env.IdentityClient__MaxRetryDelaySeconds` | Identity client max retry delay | `120` |
| `vm-api.env.IdentityClient__TokenRefreshSeconds` | Identity client token refresh | `600` |
...
| `vm-api.env.Vsphere__Hosts__*__Username` | vCenter username | `player-account@vsphere.local` |
| `vm-api.env.Vsphere__Hosts__*__Password` | vCenter password | `password` |
| `vm-api.env.Vsphere__Hosts__*__DsName` | Datastore name for file storage | `nfs-player` |
| `vm-api.env.Vsphere__Hosts__*__BaseFolder` | Folder within datastore | `player` |
| `vm-api.env.Vsphere__Timeout` | vSphere timeout | `30` |
| `vm-api.env.Vsphere__ConnectionRetryIntervalSeconds` | vSphere connection retry interval | `60` |
| `vm-api.env.Vsphere__ConnectionRefreshIntervalMinutes` | vSphere connection refresh interval | `20` |
| `vm-api.env.Vsphere__LoadCacheAfterMinutes` | vSphere load cache delay | `5` |
| `vm-api.env.Vsphere__ConnectionTimeoutSeconds` | vSphere connection timeout | `90` |
| `vm-api.env.Vsphere__LogConsoleAccess` | Log console access | `false` |
| `vm-api.env.Vsphere__CheckTaskProgressIntervalMilliseconds` | Task progress check interval | `5000` |
| `vm-api.env.Vsphere__ReCheckTaskProgressIntervalMilliseconds` | Task progress recheck interval | `1000` |
| `vm-api.env.Vsphere__HealthAllowanceSeconds` | Health allowance seconds | `180` |
...
| `vm-api.env.CorsPolicy__Methods__0` | CORS allowed methods | `""` |
| `vm-api.env.CorsPolicy__Headers__0` | CORS allowed headers | `""` |
| `vm-api.env.CorsPolicy__AllowAnyOrigin` | Allow any CORS origin | `false` |
| `vm-api.env.CorsPolicy__AllowAnyMethod` | Allow any CORS method | `true` |
| `vm-api.env.CorsPolicy__AllowAnyHeader` | Allow any CORS header | `true` |
| `vm-api.env.CorsPolicy__SupportsCredentials` | CORS supports credentials | `true` |
